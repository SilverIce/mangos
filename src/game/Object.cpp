...
{
    float new_z = GetTerrain()->GetHeight(GetPhaseMask(),x,y,z,true);
        ...
        case TYPEID_UNIT:
        {
            ...
            if (!((Creature const*)this)->CanFly())
            {
                ...
                float max_z = canSwim
                    ...
                    : ((ground_z = GetTerrain()->GetHeight(GetPhaseMask(), x, y, z, true)));
            ...
            {
                float ground_z = GetTerrain()->GetHeight(GetPhaseMask(), x, y, z, true);
                if (z < ground_z)
                    z = ground_z;
            }
            break;
